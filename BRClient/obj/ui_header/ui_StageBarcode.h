...
""));
        ...
        gridLayout_23->setContentsMargins(4, 8, 4, 8);
        ...
        gridLayout_23->addItem(verticalSpacer, 2, 0, 1, 1);

        lbVersion = new QLabel(page);
        lbVersion->setObjectName(QStringLiteral("lbVersion"));

        gridLayout_23->addWidget(lbVersion, 3, 0, 1, 1);
        ...
        gridLayout_23->setRowStretch(0, 3);
        gridLayout_23->setRowStretch(1, 3);
        gridLayout_23->setRowStretch(2, 1);
        gridLayout_23->setRowStretch(3, 1);
