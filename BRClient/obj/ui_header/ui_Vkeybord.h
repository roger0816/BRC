...
""));
        ...
        gridLayout_14 = new QGridLayout(wNumber_5);
        ...
        btnClose->setMaximumSize(QSize(40, 16777215));
        ...
        gridLayout_13->addWidget(end, 0, 1, 1, 1);

        add = new ItemKey(end2);
        add->setObjectName(QStringLiteral("add"));
        sizePolicy1.setHeightForWidth(add->sizePolicy().hasHeightForWidth());
        add->setSizePolicy(sizePolicy1);

        gridLayout_13->addWidget(add, 0, 2, 1, 1);

        sub = new ItemKey(end2);
        ...
        gridLayout_13->addWidget(sub, 0, 3, 1, 1);

        slice = new ItemKey(end2);
        slice->setObjectName(QStringLiteral("slice"));
        sizePolicy1.setHeightForWidth(slice->sizePolicy().hasHeightForWidth());
        slice->setSizePolicy(sizePolicy1);

        gridLayout_13->addWidget(slice, 0, 4, 1, 1);


        gridLayout_14->addWidget(end2, 0, 2, 1, 1);
        ...
        btnEnter->setMaximumSize(QSize(40, 16777215));
        btnEnter->setFont(font2);

        gridLayout_12->addWidget(btnEnter, 0, 0, 1, 1);


        gridLayout_14->addWidget(widget_5, 0, 3, 1, 1);
