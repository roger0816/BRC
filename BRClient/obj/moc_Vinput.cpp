...
**
** Created: Wed Dec 2 07:38:52 2015
...
static const char qt_meta_stringdata_Vinput[] = {
    "Vinput\0setText(QString)\0text\0\0"
};
...
const QMetaObjectExtraData Vinput::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Vinput::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Vinput,
      qt_meta_data_Vinput, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Vinput::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Vinput))
