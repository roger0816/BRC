...
**
** Created: Wed Dec 2 07:38:29 2015
...
static const char qt_meta_stringdata_StageBarcode[] = {
    "StageBarcode\0clicked(int,QString)\0,\0"
    "\0slotClicked()\0slotGetKey(int,QString)\0"
    "iDev,sKey\0slotToTcp()\0"
};
...
const QMetaObjectExtraData StageBarcode::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StageBarcode::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StageBarcode,
      qt_meta_data_StageBarcode, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StageBarcode::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StageBarcode))
