...
**
** Created: Wed Dec 2 07:39:08 2015
...
static const char qt_meta_stringdata_ListenKeyEvent[] = {
    "ListenKeyEvent\0signalKey(int,QString)\0"
    ",\0\0signalDevNum(int)\0"
};
...
const QMetaObjectExtraData ListenKeyEvent::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ListenKeyEvent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ListenKeyEvent,
      qt_meta_data_ListenKeyEvent, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ListenKeyEvent::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ListenKeyEvent))
