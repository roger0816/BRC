...
struct qt_meta_stringdata_ItemBarcode_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ItemBarcode_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ItemBarcode_t qt_meta_stringdata_ItemBarcode = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ItemBarcode"
...
const QMetaObject ItemBarcode::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ItemBarcode.data,
      qt_meta_data_ItemBarcode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ItemBarcode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ItemBarcode.stringdata0))
