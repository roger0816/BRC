...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CThread_t qt_meta_stringdata_CThread = {
    {
QT_MOC_LITERAL(0, 0, 7), // "CThread"
QT_MOC_LITERAL(1, 8, 9), // "signalKey"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "CThread\0signalKey\0"
};
...
void CThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CThread::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CThread::signalKey)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CThread.data,
      qt_meta_data_CThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CThread.stringdata0))
